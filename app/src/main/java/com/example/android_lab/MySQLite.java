...
import com.example.android_lab.Animal;
...
public class MySQLite extends SQLiteOpenHelper{
    ...
    public Animal pobierz(int id){
        ...
        Cursor cursor = db.query("animals", /*a.table name*/ new String[]{"_id","gatunek","kolor","wielkosc","opis"},/*b.columnn ames*/"_id = ?", /*c.selections*/ new String[] {String.valueOf(id)},/*d.selection args*/ null, null, null, null);
